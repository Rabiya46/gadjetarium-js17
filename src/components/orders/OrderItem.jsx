...
const OrderItem = () => {
  ...
  const products = productName?.length
    ? productName.split(", ")
    : ["Don't have"];
          ...
          <Box className="container">
              ...
              <Box className="first-child">
                <Box className="ul-box">
                  ...
                  <Typography className="li discount">
                    Скидка: {discountPercent || 0}%
                  </Typography>
                  <Typography className="li">Сумма после скидки:</Typography>
                  <Typography className="li">Метод оплаты:</Typography>
                </Box>
                ...
                <Box className="ul-box">
                  ...
                  <Typography className="li-value">
                    {priceProductSeparate(Number(priceBeforeDiscount || 0))} с
                  </Typography>
                  <Typography className="li-value-last">
                    {priceProductSeparate(Number(totalPrice || 0))} с
                  </Typography>
            ...
            <Box className="second">
              ...
              <Box className="order-number">
                ...
                <Typography className="li-value">{id || 0}</Typography>
              </Box>

              <Box className="order-number">
                <Typography className="li">Состояние:</Typography>
                <Typography className="li-value">
                  {checkInOrderStatus(status)}
                </Typography>
              </Box>

              <Box>
                <Typography className="li">Имя получателя:</Typography>
                <Typography className="li-value">
                  {contactName || "Don't have"}
                </Typography>
              </Box>
